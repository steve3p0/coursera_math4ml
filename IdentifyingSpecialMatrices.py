...
print("A is a singular Matrix - It's Determinant is Zero")
A = np.array([
        [2, 0, 0, 0],
        [0, 3, 0, 0],
        [0, 0, 4, 4],
...
print(f"A = \n{A}")
print(f"isSingular(A) = {isSingular(A)} (Expected Answer: True)")
print(f"Determinate of A: {np.linalg.det(A)}")
...
print(f"A[0,0] = {A[0,0]}")
print(f"NO CHANGE A[0] = {A[0]}")
A[0] = A[0] + A[1]
print(f"R0 + R1 -> A[0] = {A[0]}")
A[0] = A[0] + A[2]
print(f"R0 + R2 -> A[0] = {A[0]}")
A[0] = A[0] + A[3]
print(f"R0 + R3 -> A[0] = {A[0]}")

A[0] = A[0] / A[0,0]
print(f"R0 / R0C0 -> A[0] = {A[0]}")
print(A)

print("\n\n---- FixRowOne ---------------")
A[1] = A[1] - A[1,0] * A[0]
print(f"R1 - R1C0 * R0 - > R1 = {A[1]}")


print()
print()

print("B is NOT a singular Matrix - It's Determinant is Non-Zero")
B = np.array([
        [0, 7, -5, 3],
        [2, 8, 0, 4],
        [3, 12, 0, 5],
...
print(f"B = \n{B}")
print(f"isSingular(B) = {isSingular(B)} (Expected Answer: False)")
print(f"Determinate of B: {np.linalg.det(B)}")
